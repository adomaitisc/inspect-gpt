...
export default function Home() {
  return (
    <>
      <div
        id="blob"
        className=" h-96 w-96 bg-blue-300 absolute pointer-events-none -z-20 blur-3xl"
      ></div>
      <div id="bg" className="h-[130vh] w-screen absolute -z-10"></div>
      <Head>
      ...
      <main className="w-full h-full flex flex-col items-center">
        ...
        <section className="flex flex-col gap-10 py-20 items-center">
          ...
          <motion.button
            ...
            className="flex gap-2 items-center justify-center bg-gpt-500 text-white text-lg font-semibold rounded-2xl px-6 py-2 shadow-sm hover:bg-gpt-400 hover:rounded-xl duration-300"
          >
